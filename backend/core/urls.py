...
urlpatterns = [
    ...
    path('api/schedule/restore/', schedule_views.restore_schedule_lesson, name='restore_schedule_lesson'),
    ...
    path('api/attendance/edit/', schedule_views.edit_attendance, name='edit_attendance'),
    path('api/attendance/history/', schedule_views.get_attendance_history, name='get_attendance_history'),
    
    # Мугалим үчүн жоктоо тарыхы
    path('teacher/attendance-history/', schedule_views.teacher_attendance_history, name='teacher_attendance_history'),
    path('api/teacher/attendance-history/', schedule_views.get_teacher_attendance_history_api, name='get_teacher_attendance_history_api'),
    path('api/attendance/bulk-edit/', schedule_views.bulk_edit_attendance, name='bulk_edit_attendance'),
