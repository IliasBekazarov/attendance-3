...
class UserProfile(models.Model):
    ...
    # students талаасы алынып салынды - Student.parents аркылуу байланыш түзүлөт (related_name='parent_profiles')
...
class Attendance(models.Model):
    ...
    time_slot = models.ForeignKey('TimeSlot', on_delete=models.SET_NULL, null=True, blank=True, verbose_name="Убакыт периоду")
