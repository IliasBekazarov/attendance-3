...
const translations = {
  ky: {
    ...
    markAllPresent: 'Баарын бар',
    markAllLate: 'Баарын кеч',
    markAllAbsent: 'Баарын жок',
  ...
  ru: {
    ...
    todaySchedules: 'Ваши сегодняшние занятия',
    noLessonsToday: 'Сегодня нет занятий',
    noLessonsTodayDesc: 'В вашем сегодняшнем расписании нет занятий',
    selectLesson: 'Выбрать',
    back: 'Назад',
    room: 'Кабинет',
    students: 'студентов',
  ...
  en: {
    ...
    todaySchedules: "Your Today's Lessons",
    noLessonsToday: 'No Lessons Today',
    noLessonsTodayDesc: 'You have no lessons in today\'s schedule',
    selectLesson: 'Select',
    back: 'Back',
    room: 'Room',
    students: 'students',
